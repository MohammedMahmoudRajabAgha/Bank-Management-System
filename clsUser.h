...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperater = "#//#")
    {
        ...
        vector<string>LoginRegisterDataLine = clsString::Split(Line, Seperater);
...
public:
    ...
    enum enPermissions
    {
        eAll = -1, pTransactions = 1, pManageClients = 2, pManageUsers = 4
        , pShowLogInRegister = 8, pShowLogoutRegister = 16
    };
